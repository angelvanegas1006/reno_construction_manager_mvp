 ...
 * Usa la view viwnDG5TY6wjZhBL2 que contiene propiedades en fase Final Check
 * Uso: npm run sync:final-check
 */
...
async function main() {
  console.log('🔄 Iniciando sincronización de Final Check desde Airtable...\n');
  ...
  try {
    ...
    console.log('\n✅ Todas las propiedades de Final Check han sido sincronizadas correctamente.');
  } catch (error: any) {
